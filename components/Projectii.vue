<template>
  <div
    ...
    ">
    <div class="px-[20px] relative pt-[86px] lg:pt-10 h-[100dvh]">
      <span
        v-html="arrow"
  ...
  <!-- Card -->
  <div
    class="flex justify-center md:justify-start lg:justify-start gap-x-[25px] cursor-pointer grayscale hover:grayscale-0 duration-300"
    @click="isOpen = true">
    <img
      :src="image"
